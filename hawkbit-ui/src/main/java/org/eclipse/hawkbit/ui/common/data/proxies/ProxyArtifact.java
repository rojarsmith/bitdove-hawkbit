...
public class ProxyArtifact extends ProxyIdentifiableEntity {
	 ...
	 * Sets the md5Hash
	 *
	 * @param md5Hash md5 format hash value
	 */
	 ...
	 * Sets the sha1Hash
	 *
	 * @param sha1Hash sha1 format hash value
	 */
	 ...
	 * Sets the sha256Hash
	 *
	 * @param sha256Hash sha256 format hash value
	 */
	 ...
	 *
	 * @param modifiedDate artifact modified date
	 */
